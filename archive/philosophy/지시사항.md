...
3. `03_차원3_Function/00_차원3_개요.md`
...
| 2025-01-20 | **v2.0 업데이트** - Phase 0 추가, Phase 1/2 수정, 프레임워크 v2.0 반영<br>• Phase 0: GR 프레임워크 기반 설계 (완료)<br>• Layer 0 신설, Layer 7 확장 (AI 워크로드)<br>• Zone 0 세분화 (0-A: Untrusted, 0-B: Trusted Partner)<br>• Domain T (Tech Stack), Domain I (Interface) 추가<br>• Function 280+ (기존 210+에서 70개 추가)<br>• 하이브리드 DB 아키텍처 (PostgreSQL + Neo4j + Pinecone)<br>• 2-Tier 데이터 모델 (Product Master + Component Archetypes) | Claude Code |
